const CACHE_NAME = 'rezero-cache-echidna-and-beatrice-approved-finished-toast-speech-v31';
// Assets to cache initially
const INITIAL_ASSETS = [
  '/',
  '/index.html',
  '/Assets/styles/style.min.css',
  '/Assets/script/minified/script.min.js',
  '/Assets/script/minified/jquery.min.js',
  '/Assets/script/minified/loader.min.js',
...
self.addEventListener('fetch', event => {
  ...
  const isVideo = url.hostname === 'rezero-vi.7849684.xyz';
