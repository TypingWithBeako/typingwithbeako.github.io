...
- Các video sẽ **tự động lưu vào bộ nhớ đệm** sau khi bạn xem qua **1 lần** và sẽ **không cần tải lại** vào lần xem tiếp theo.
- Bạn có thể **cài đặt ứng dụng** để thuận tiện hơn trong việc sử dụng.
